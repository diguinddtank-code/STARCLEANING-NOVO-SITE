  ...
  return (
    ...
    >
      ...
      <div className={`relative overflow-hidden transition-all duration-500 ${isOpen ? 'h-24 lg:h-32' : 'h-48 lg:h-56'}`}>
        ...
        <img src={image} alt={`${title} Service Charleston & Summerville`} className="w-full h-full object-cover transform group-hover:scale-110 transition duration-700 ease-out" />
        {tag && (
