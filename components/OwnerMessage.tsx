...
const OwnerMessage: React.FC<OwnerMessageProps> = ({ quoteHref = '/#quote' }) => {
  return (
    <section className="py-16 lg:py-24 bg-white relative overflow-hidden isolate">
          ...
          <div className="lg:w-5/12 relative flex flex-col items-center group">
            ...
            <div className="relative z-10 w-[280px] h-[350px] sm:w-[320px] sm:h-[400px] lg:w-[380px] lg:h-[475px]">
              ...
              <Image
                ...
                alt="Mariana, owner of Star Cleaning SC, holding a Cleaning for a Reason charity card"
                fill
