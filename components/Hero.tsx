      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pb-16 lg:pb-0">
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-20">
          ...
          <div className="lg:w-1/2 text-center lg:text-left pt-2 lg:pt-0">
            ...
            {/* TRUST CAPSULE */}
            <div className="inline-flex items-center gap-3 bg-white/70 backdrop-blur-md border border-gray-200/50 px-4 py-2 rounded-full shadow-sm mb-6 lg:mb-8 animate-fade-in mx-auto lg:mx-0 cursor-default hover:bg-white/90 transition-colors">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start items-center w-full">
              ...
              <div className="flex flex-col w-full sm:hidden gap-2">
                  <div className="flex w-full gap-3">
                      <button onClick={() => onStartQuote && onStartQuote({})} className="flex-1 bg-star-blue hover:bg-star-dark text-white rounded-xl shadow-md text-center flex flex-col items-center justify-center border-b-4 border-blue-900 active:border-b-0 active:translate-y-1 transition-all py-3 relative overflow-hidden group">
              ...
              {/* Desktop Guarantee */}
              <div className="hidden sm:flex items-center gap-2 text-sm font-bold text-gray-600 px-4 py-2 h-fit self-center border-l border-gray-300 ml-2">
                <i className="fas fa-shield-alt text-green-600 text-xl"></i>
                <span className="leading-tight text-left text-xs">100% Satisfaction<br />Guaranteed</span>
              </div>
            </div>
            
            {/* MOBILE TRUST INDICATORS + GOOGLE SOCIAL PROOF */}
            <div className="sm:hidden flex flex-col items-center gap-3 mt-5">
                {/* 1. Standard Trust Line */}
                ...
                {/* 2. NEW Google Social Proof Badge */}
                <div className="flex items-center gap-2 bg-white/80 backdrop-blur-md border border-gray-100 px-3 py-1.5 rounded-full shadow-sm">
                    ...
                    <span className="text-[10px] font-bold text-gray-600">5.0 Customer Rating</span>
                </div>
            </div>
          </div>
