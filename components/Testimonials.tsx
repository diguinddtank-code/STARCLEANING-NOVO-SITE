  ...
  return (
    <section id="reviews" className="py-16 lg:py-24 bg-gradient-to-b from-white to-orange-50 overflow-hidden relative">
      ...
      <div className="text-center mt-8 lg:mt-12 relative z-20">
          <a href="https://www.google.com/search?q=Star+Cleaning+SC" target="_blank" rel="noreferrer" className="inline-flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-md text-gray-600 hover:text-star-blue transition font-bold text-sm border border-gray-100 hover:scale-105 duration-300">
