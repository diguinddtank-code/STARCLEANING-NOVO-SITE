export const locationsData: Record<string, any> = {
  charleston: {
    ...
    intro: "If you are searching for reliable **house cleaning Charleston SC** residents can truly depend on, you have come to the right place. Living in the Holy City means spending your weekends strolling down Rainbow Row, enjoying the breeze at The Battery, or dining out on King Street—not scrubbing baseboards and mopping floors. Star Cleaning SC is a veteran-owned business bringing 18 years of experience and military precision to every home we touch. We understand the unique charm and specific upkeep required for historic Charleston homes, from managing coastal humidity to preserving delicate hardwood floors. Our highly trained, background-checked team uses pet-safe products to ensure your family and furry friends are always protected. Let us handle the dirty work so you can get back to enjoying everything that makes living in Charleston so incredibly special.",
    whyChooseUs: [
  ...
  "north-charleston": {
    ...
    intro: "Finding dependable **house cleaning North Charleston SC** residents trust shouldn't be a chore. Whether you are commuting to Boeing, running errands near the Tanger Outlets, or enjoying an evening out in vibrant Park Circle, your time is incredibly valuable. Star Cleaning SC is here to take the burden of household chores completely off your shoulders. As a veteran-owned business with 18 years of hands-on experience, we pride ourselves on delivering military-precision cleaning to every home and apartment we service. We use pet-safe, eco-friendly products to ensure a healthy environment for your entire family. From standard weekly upkeep to intensive post-construction cleanups, our background-checked professionals are dedicated to making your North Charleston home shine so you can focus on what truly matters.",
    whyChooseUs: [
  ...
  ladson: {
    ...
    intro: "When you are looking for meticulous **house cleaning Ladson SC** families can rely on, Star Cleaning SC is the premier choice. Ladson is known for its wonderful, family-friendly neighborhoods and community events like the Coastal Carolina Fair at Exchange Park. With so much to do with your family, spending your weekends scrubbing bathrooms shouldn't be on the itinerary. As a proud veteran-owned business with 18 years of professional experience, we bring a level of military precision to home cleaning that is simply unmatched in the Lowcountry. We specialize in everything from routine maid services to intensive deep cleans, always utilizing pet-safe products to protect your loved ones. Let our dedicated team transform your living space so you can focus on making memories, not doing chores.",
    whyChooseUs: [
  ...
  summerville: {
    ...
    intro: "If you need the most thorough **house cleaning Summerville SC** has available, Star Cleaning SC is ready to serve. Known as the Birthplace of Sweet Tea and famous for the beautiful Azalea Park and Flowertown Festival, Summerville is a town meant to be enjoyed outdoors—not spent indoors scrubbing floors. Whether you live in the historic downtown district or a brand-new build in Nexton, our veteran-owned team brings 18 years of experience and military discipline to your doorstep. We understand how local pollen and dust can quickly accumulate in Lowcountry homes, which is why we use meticulous checklists and pet-safe products to ensure a deep, lasting clean. Let us take the burden of housekeeping off your plate so you can get back to enjoying the sweet life in Summerville.",
    whyChooseUs: [
  ...
  "james-island": {
    ...
    intro: "If you are searching for top-tier **house cleaning James Island SC** residents trust, Star Cleaning SC is here to deliver. Living on James Island offers a laid-back, beautiful coastal lifestyle. Whether you are taking the dog to James Island County Park, heading out to Folly Beach, or enjoying the marsh views, you shouldn't be stuck inside doing chores. As a veteran-owned business with 18 years of experience, we bring military precision to every home we clean. We know that coastal living brings unique challenges like tracked-in sand and salt air residue, and our team is fully equipped to handle it. We use eco-friendly, pet-safe products to ensure your home is not only sparkling clean but completely safe for your family. Let us handle the mess so you can enjoy island living.",
    whyChooseUs: [
  ...
  "daniel-island": {
    ...
    intro: "If you demand excellence and are looking for premium **house cleaning Daniel Island SC** residents trust, you have found your match. Daniel Island is a stunning, master-planned community where residents enjoy golf courses, walking trails along the Wando River, and events at Credit One Stadium. Your home here is a significant investment, and maintaining it shouldn't consume your precious free time. Star Cleaning SC is a veteran-owned business bringing 18 years of military precision to luxury home care. We understand the high standards expected in Daniel Island homes, which is why our background-checked professionals use meticulous checklists and eco-friendly, pet-safe products. Whether you need weekly upkeep or an intensive deep clean, we deliver a flawless result so you can enjoy the island lifestyle to the fullest.",
    whyChooseUs: [
