...
import { ShieldCheck, Sparkles, Star, UserCheck, Award, CheckCircle2, RotateCcw, Lock, Phone } from 'lucide-react';
...
const QuoteLanding = () => {
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-800 selection:bg-yellow-200 selection:text-star-blue">
      ...
      {/* 100% Satisfaction Guarantee Section - Matches Home Page Design Language */}
