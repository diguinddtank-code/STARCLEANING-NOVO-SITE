...
import { MapPin, Star, ShieldCheck, ThumbsUp, Leaf, ArrowRight, CheckCircle2, Sparkles, Home, BedDouble, Phone } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative h-72 sm:h-96 lg:h-[520px] rounded-3xl overflow-hidden shadow-2xl order-1 lg:order-2">
              ...
              <div className="absolute bottom-6 left-6 sm:bottom-8 sm:left-8 text-white">
                <p className="uppercase tracking-[0.2em] text-xs sm:text-sm font-bold">Spotless Homes</p>
                <p className="uppercase tracking-[0.2em] text-xs sm:text-sm font-bold">Every Visit</p>
