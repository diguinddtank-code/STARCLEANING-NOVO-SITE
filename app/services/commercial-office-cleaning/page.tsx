          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="relative h-72 sm:h-96 lg:h-[520px] rounded-3xl overflow-hidden shadow-2xl order-1 lg:order-2">
              ...
              <div className="absolute bottom-6 left-6 sm:bottom-8 sm:left-8 text-white">
                <p className="uppercase tracking-[0.2em] text-xs sm:text-sm font-bold">Spotless Office</p>
                <p className="uppercase tracking-[0.2em] text-xs sm:text-sm font-bold">Every Day</p>
            ...
            <div className="order-2 lg:order-1">
              ...
              <h1 className="text-3xl sm:text-4xl font-black text-gray-900 font-heading leading-tight">
                Professional<br />
                <span className="text-star-blue">Commercial Cleaning</span>
              </h1>
              <div className="w-12 h-1 bg-star-blue rounded-full my-4"></div>

              <div className="text-gray-600 text-base leading-relaxed space-y-3">
                <p>
                  <strong className="text-gray-900 font-bold">Maintain a pristine, productive workspace.</strong>{' '}
                  Our veteran-owned team delivers military-grade precision to offices, retail spaces, and facilities across the Lowcountry.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-x-6 gap-y-3 mt-6">
                ...
                >
                  Get a Free Commercial Quote <ArrowRight className="w-4 h-4" />
                </Link>
                <a
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          <p className="text-lg text-slate-600 leading-relaxed">
            A clean workspace is not just about aesthetics; it is a fundamental driver of employee productivity, health, and client perception. When searching for reliable <Link href="/locations/charleston" className="text-star-blue font-semibold hover:underline">commercial cleaning in Charleston, SC</Link>, businesses need a partner who understands the unique demands of professional environments. Star Cleaning SC brings 18 years of military-honed discipline to every office, retail store, and commercial facility we service. We know that a spotless reception area builds immediate trust with your visitors, while sanitized breakrooms and restrooms keep your workforce healthy and focused. Our background-checked, highly trained team utilizes eco-friendly, pet-safe products to deliver a superior clean without harsh chemical odors, ensuring your business operations run smoothly and your brand shines brightly in the competitive Lowcountry market.
          </p>
        </div>
      </section>
          ...
          <div className="my-10 p-8 md:p-12 rounded-3xl bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 max-w-3xl mb-12 text-left">
              ...
              <p className="text-slate-300 text-base md:text-lg leading-relaxed">
                We proudly bring our elite, veteran-owned commercial and office cleaning services directly to your facility. Choose your neighborhood below to connect with our local precision teams:
              </p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 relative z-10 mb-6 text-left">
              {[
                { name: "Charleston", url: "/locations/charleston", hover: "Historic Peninsula & Downtown Offices", zip: "29401" },
                { name: "North Charleston", url: "/locations/north-charleston", hover: "Boeing, Tanger & Industrial Hubs", zip: "29405" },
                { name: "Summerville", url: "/locations/summerville", hover: "Corporate centers & Nexton developments", zip: "29483" },
                { name: "Ladson", url: "/locations/ladson", hover: "Suburban offices & Retail establishments", zip: "29456" },
                { name: "James Island", url: "/locations/james-island", hover: "Executive suites & Medical clinics", zip: "29412" },
                { name: "Daniel Island", url: "/locations/daniel-island", hover: "Wando River Waterfront corporate parks", zip: "29492" }
              ].map((loc, i) => (
                <Link 
                  key={i} 
                  href={loc.url} 
